...
const Header = () => {
    return (
        <>
            <header className="m-auto max-w-[1540px] w-[100%] block z-50">
            ...
            <div className="flex flex-row justify-between py-2 px-[50px] sm:px-[50px] lg:px-[150px] bg-white opacity-90 sticky z-40 top-0">
